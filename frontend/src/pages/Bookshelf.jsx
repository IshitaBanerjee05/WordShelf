...
export default function Bookshelf() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      {mockBooks.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 text-slate-400 col-span-4">
          <BookOpen className="w-16 h-16 opacity-20 mb-4" />
          <p className="font-semibold text-base">Your bookshelf is empty.</p>
          <p className="text-sm mt-1">Click "Add Resource" to add your first book or article.</p>
        </div>
      ) : (
