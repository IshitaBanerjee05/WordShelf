...
import { User, Mail, Lock, Save, CheckCircle2, AlertCircle, Loader2, BookMarked, Calendar } from 'lucide-react';
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="border-t border-slate-100 pt-6">
            <p className="text-sm font-semibold text-slate-700 mb-4 flex items-center gap-2">
              <Lock className="w-4 h-4 text-slate-400" /> Change Password <span className="text-xs font-normal text-slate-400">(leave blank to keep current)</span>
            </p>
